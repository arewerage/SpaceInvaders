...
namespace _Project._Codebase.Core.Assets.Provider
{
    public class AssetProvider : IAssetProvider
    {
        ...
        private static async UniTask<AssetLoadResult<T>> LoadAsync<T>(AsyncOperationHandle<T> handle) where T : class
        {
            T obj = await handle;
